...
import static com.rico.rbi.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public String getOpenid(String code)throws Exception{
        ...
        url += "?appid=wxf44b1bb2e9847d72";//自己的appid
        url += "&secret=cc098ea91318e073d26e55a6ec348996";//自己的appSecret
        url += "&js_code=" + code;
        ...
        RequestConfig requestConfig = RequestConfig.custom()          // 设置连接超时时间(单位毫秒)
                .setConnectTimeout(Timeout.ofDays(5000))                    // 设置请求超时时间(单位毫秒)
                .setConnectionRequestTimeout(Timeout.ofDays(5000))             // socket读写超时时间(单位毫秒)// 设置是否允许重定向(默认为true)
